...
${row.to}`.toLowerCase().includes(needle));
    ...
    const allVisibleSelected = visible.length > 0 && visible.every((row) => selection[selectionKey(folder, row.uid)] !== void 0);
    return el(
      "div",
...
var BUTTON_PLAIN = "rounded-md border border-gray-300 px-3 py-1.5 text-xs font-medium text-gray-700 disabled:cursor-not-allowed disabled:opacity-50";
var BUTTON_DANGER = "rounded-md bg-red-600 px-3 py-1.5 text-xs font-medium text-white disabled:cursor-not-allowed disabled:opacity-50";
  ...
  return function MailSettingsPanel() {
    ...
    async function bind() {
      ...
      try {
        ...
        setNotice(
          existed ? `\u90AE\u7BB1 ${candidate.email} \u7684\u6388\u6743\u7801\u5DF2\u66F4\u65B0\u5E76\u8BBE\u4E3A\u5F53\u524D\u3002` : `\u90AE\u7BB1 ${candidate.email} \u5DF2\u7ED1\u5B9A\u5E76\u8BBE\u4E3A\u5F53\u524D\uFF08IMAP \u4E0E SMTP \u5747\u9A8C\u8BC1\u901A\u8FC7\uFF09\u3002\u53EF\u5728\u53F3\u4FA7\u300C\u90AE\u4EF6\u300D\u9762\u677F\u9876\u90E8\u5207\u6362\u90AE\u7BB1\u3002`
        );
      } catch (cause) {
    ...
    async function testConnection(account) {
      ...
      try {
        ...
        await reload();
        setNotice(`\u6D4B\u8BD5\u901A\u8FC7\uFF1A${account.email} \u7684 IMAP \u767B\u5F55\u4E0E SMTP \u8BA4\u8BC1\u5747\u6B63\u5E38\u3002`);
      } catch (cause) {
    ...
    const accountCard = (account) => {
      ...
      return createElement(
        "div",
        { key: account.email, className: "flex flex-col gap-2 rounded-md border border-gray-200 p-3" },
        createElement(
          "div",
          { className: "flex flex-wrap items-center gap-2" },
          createElement("span", { className: "text-sm font-medium text-gray-800" }, account.email),
          isActive ? createElement("span", { className: "rounded-full bg-blue-50 px-2 py-0.5 text-xs font-medium text-blue-600" }, "\u5F53\u524D\u4F7F\u7528") : null
        ),
        endpointText("IMAP", account.imap),
        endpointText("SMTP", account.smtp),
        status !== void 0 ? createElement(
          "p",
        ...
        createElement(
          ...
          confirmUnbindEmail === account.email ? createElement("button", { type: "button", className: BUTTON_DANGER, disabled: busy, onClick: () => void unbind(account) }, "\u786E\u8BA4\u89E3\u7ED1\uFF08\u5220\u9664\u672C\u673A\u6388\u6743\u7801\uFF09") : createElement("button", { type: "button", className: BUTTON_PLAIN, disabled: busy, onClick: () => setConfirmUnbindEmail(account.email) }, "\u89E3\u7ED1"),
          confirmUnbindEmail === account.email ? createElement("button", { type: "button", className: "text-xs text-gray-500 underline", disabled: busy, onClick: () => setConfirmUnbindEmail("") }, "\u53D6\u6D88") : null
        )
      );
    };
    return createElement(
      ...
      accounts.length > 0 ? createElement(
        ...
        createElement("h3", { className: "text-sm font-medium text-gray-800" }, `\u5DF2\u7ED1\u5B9A ${accounts.length} \u4E2A\u90AE\u7BB1\uFF08\u5BF9\u8BDD\u4E0E\u9762\u677F\u9ED8\u8BA4\u7528\u300C\u5F53\u524D\u4F7F\u7528\u300D\u7684\u90A3\u4E2A\uFF09`),
        ...accounts.map(accountCard)
      ) : createElement("p", { className: "text-sm text-gray-500" }, "\u8FD8\u6CA1\u6709\u7ED1\u5B9A\u90AE\u7BB1\u3002\u7ED1\u5B9A\u540E AI \u53EF\u771F\u5B9E\u6536\u53D1\u90AE\u4EF6\uFF1B\u53EF\u4EE5\u7ED1\u5B9A\u591A\u4E2A\uFF08\u5982\u5DE5\u4F5C\u90AE\u7BB1 + QQ \u90AE\u7BB1\uFF09\uFF0C\u5728\u9762\u677F\u9876\u90E8\u5207\u6362\u3002"),
      createElement(
        "div",
        { className: "flex flex-col gap-3" },
        createElement("h3", { className: "text-sm font-medium text-gray-800" }, accounts.length > 0 ? "\u6DFB\u52A0 / \u66F4\u65B0\u90AE\u7BB1" : "\u7ED1\u5B9A\u90AE\u7BB1\uFF08AI \u5C06\u4EE5\u6B64\u90AE\u7BB1\u6536\u53D1\u90AE\u4EF6\uFF09"),
        createElement(
          "label",
        ...
        createElement(
          ...
          createElement("input", {
            className: INPUT_CLASS,
            placeholder: "\u4F8B\u5982 lawyer@163.com\uFF08\u53EF\u7ED1\u5B9A\u591A\u4E2A\uFF09",
            value: email,
            disabled: busy,
        ...
        createElement(
          ...
          createElement("span", { className: "text-xs text-gray-400" }, "\u5C06\u771F\u5B9E\u8FDE\u63A5 IMAP \u767B\u5F55\u5E76\u5B8C\u6210 SMTP \u8BA4\u8BC1\uFF0C\u5168\u90E8\u901A\u8FC7\u624D\u4FDD\u5B58\uFF1B\u540C\u4E00\u90AE\u7BB1\u518D\u6B21\u7ED1\u5B9A\u89C6\u4E3A\u66F4\u65B0\u6388\u6743\u7801\u3002")
        ),
        createElement(
          "p",
