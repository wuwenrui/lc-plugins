...
var PILL_NEUTRAL = "rounded-full bg-badge-neutral-background px-2.5 text-caption-2-medium text-text-tertiary cursor-pointer";
var PILL_ACTIVE = "rounded-full bg-pill-tab-blue-selected-background px-2.5 text-caption-2-medium text-status-blue-text";
var PILL_STYLE = { padding: "2px 10px" };
...
function createMailSettingsPanel(ctx) {
  ...
  return function MailSettingsPanel() {
    ...
    const accountCard = (account) => {
      ...
      return createElement(
        "div",
        { key: account.email, className: "flex flex-col gap-2 rounded-lg border border-separator-border bg-background-quaternary-default p-2.5" },
        createElement(
          "div",
