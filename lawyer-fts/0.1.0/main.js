...
function findReadOnlyTool(tools, name) {
  ...
  if (!isReadTool(found)) throw new FtsError("unsupported");
  return found;
}
...
function renderToolsText(tools, retrievedAt) {
  if (!tools.length) {
    return "\u6CD5\u5929\u4F7F\u5408\u540C\u5E93 MCP \u5F53\u524D\u6CA1\u6709\u53EF\u7528\u7684\u53EA\u8BFB\u5DE5\u5177\u3002\u53EF\u7A0D\u540E\u91CD\u8BD5\u3002";
  }
  ...
  return [
    `\u6CD5\u5929\u4F7F\u5408\u540C\u5E93 MCP \u53EF\u7528\u53EA\u8BFB\u5DE5\u5177 ${tools.length} \u4E2A\uFF08\u6765\u6E90\uFF1A\u6CD5\u5929\u4F7F\u5B98\u65B9 MCP\uFF0C\u68C0\u7D22\u65F6\u95F4 ${retrievedAt}\uFF09\uFF1A`,
    ...lines,
    "\u63D0\u793A\uFF1A\u8C03\u7528 fts_call_tool \u65F6 tool \u586B\u4E0A\u9762\u7684\u540D\u79F0\u3001arguments \u6309\u5165\u53C2 schema \u586B\u5199\uFF1B\u4EC5\u652F\u6301\u53EA\u8BFB\u64CD\u4F5C\uFF0C\u5199\u64CD\u4F5C\u4F1A\u88AB\u62D2\u7EDD\u3002"
  ].join("\n");
}
...
function assertNotWriteTool(name) {
  if (WRITE_NAME_PATTERN.test(name)) throw new FtsError("unsupported");
}
...
function activate(ctx) {
  ...
  disposers.push(
    ctx.tools.register({
      name: "fts_list_tools",
      description: "\u5217\u51FA\u6CD5\u5929\u4F7F\u5408\u540C\u5E93 MCP \u5F53\u524D\u8D26\u53F7\u53EF\u7528\u7684\u53EA\u8BFB\u5DE5\u5177\u53CA\u5165\u53C2 schema\uFF08\u5199\u64CD\u4F5C\u4E0D\u5728\u5217\uFF09\u3002\u5148\u7528\u5B83\u786E\u8BA4\u5DE5\u5177\u540D\u4E0E\u53C2\u6570\uFF0C\u518D\u8C03\u7528 fts_call_tool\u3002",
      inputSchema: {
        type: "object",
      ...
      execute: (args = {}) => runTool(async () => {
        ...
        const tools = filterReadOnlyTools(await listTools(), keyword);
  ...
  disposers.push(
    ctx.tools.register({
      name: "fts_call_tool",
      description: "\u8C03\u7528 fts_list_tools \u5217\u51FA\u7684\u6CD5\u5929\u4F7F\u53EA\u8BFB\u5DE5\u5177\u68C0\u7D22\u5408\u540C\u6A21\u677F\uFF08\u641C\u7D22\u6A21\u677F\u3001\u67E5\u770B\u6A21\u677F\u4FE1\u606F\u6216\u6B63\u6587\u7B49\uFF09\u3002tool \u5FC5\u586B\u3001arguments \u5FC5\u586B\u4E14\u9700\u7B26\u5408\u8BE5\u5DE5\u5177\u7684 inputSchema\uFF1B\u53EA\u8BFB\u767D\u540D\u5355\u4E4B\u5916\u7684\u5199\u64CD\u4F5C\u4F1A\u88AB\u62D2\u7EDD\u3002\u6A21\u677F\u4F7F\u7528\u7528\u6237\u6CD5\u5929\u4F7F\u8D26\u53F7\u7684\u4F1A\u5458\u6743\u76CA\uFF1B\u4E0D\u81EA\u52A8\u6279\u91CF\u7A77\u4E3E\u3002",
      inputSchema: {
        type: "object",
        additionalProperties: false,
        properties: {
